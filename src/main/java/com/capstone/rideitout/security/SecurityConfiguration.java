...
@Autowired
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/profile", "/profile/update", "/payment", "/manage",  "/listyourride", "/car/*/edit", "/car/*/delete", "/create/**", "/profile/delete", "deleteImg/*", "/car/*/addPhoto", "/delete").authenticated()
